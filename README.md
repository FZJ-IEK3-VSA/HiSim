...
For this you need to add the `PostProcessingOptions` (`hisim/hisim/postprocessingoptions.py`) to your `SimulationParameters` when you are running your Household System Setup in `HiSim/system_setups`.
