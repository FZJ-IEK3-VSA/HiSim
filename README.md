...
```bash
hisim energy-system run energy_systems/simple_system_setup_one.energy_system.yaml simulation_parameters/one_day_15min_export.simulation.yaml
```
or

```bash
hisim energy-system run energy_systems/simple_system_setup_two.energy_system.yaml simulation_parameters/one_day_15min_export.simulation.yaml
```
...
```bash
hisim energy-system run energy_systems/basic_household.energy_system.yaml simulation_parameters/2021_minutely_plots.simulation.yaml
```
...
For this you list the respective `PostProcessingOptions` (`hisim/postprocessingoptions.py`) under `post_processing_options` in the simulation file: `simulation_parameters/2021_minutely_plots.simulation.yaml` selects the plots, `simulation_parameters/one_day_15min_export.simulation.yaml` only the CSV export.
