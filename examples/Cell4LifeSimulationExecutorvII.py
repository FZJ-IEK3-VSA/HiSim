...
"""This class executes Cell4Life Simulation
    To Do:
    # [ ] Für die Öknomische Bewertung im Excel wird derzeit noch eine falsche H2 Speichergröße ins Excel gespeichert: Dieser Wert gehört noch um die theoretischen Speicherverluste korrigiert! 
    # [x] im Cell4LifeScenario1a_1b.py --> Electrolyzer Fuel Cell Controller bzgl. Namen verändern;
    # [x] Hydrogen storage: Electrolyser soll jetzt eigentlich weder zuviel auffüllen noch fuel cell zuviel raus verbrauchen
