...
def household_ac_explicit(my_sim: Simulator, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:
    ...
    Representative Locations selected according to climate zone with focus on the Mediterranean climate as it has the highest cooling
    demand.

    TABULA code for the exemplary single family household are chosen according to the construction year class:
    ...
    Remarks about the model predictive controller (MPC):
        ...
        Future work: improving the implementation with automatic scaling of the optimal control problem formulation. This (could)
