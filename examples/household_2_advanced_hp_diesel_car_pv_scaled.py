...
@dataclass_json
@dataclass
class HouseholdAdvancedHPDieselCarPvScaledConfig:
    ...
    def get_default(cls):
        ...
        household_config = HouseholdAdvancedHPDieselCarPvScaledConfig(
            building_type="blub",
...
def household_2_advanced_hp_diesel_car_pv_scaled(
    ...
    config_filename = "household_2_advanced_hp_diesel_car_pv_scaled_config.json"

    my_config: HouseholdAdvancedHPDieselCarPvScaledConfig
    if Path(config_filename).is_file():
        with open(config_filename, encoding="utf8") as system_config_file:
            my_config = HouseholdAdvancedHPDieselCarPvScaledConfig.from_json(system_config_file.read())  # type: ignore
        log.information(f"Read system config from {config_filename}")
    else:
        my_config = HouseholdAdvancedHPDieselCarPvScaledConfig.get_default()
