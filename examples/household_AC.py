...
def household_AC_explicit(
    ...
    if control == "PID":
        ...
        pid_controller = PIDcontroller.PIDController(
            my_simulation_parameters=my_simulation_parameters, ki=ki, kp=kp, kd=kd
        )
    ...
    if control == "PID":
        my_air_conditioner.connect_input(
            my_air_conditioner.ElectricityOutputPID,
