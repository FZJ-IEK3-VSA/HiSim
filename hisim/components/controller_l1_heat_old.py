...
class ControllerHeat(cp.Component):
    ...
    def i_simulate(self, timestep: int, stsv: cp.SingleTimeStepValues, force_convergence: bool) -> None:
        ...
        # Simulate WarmWater
        delta_temperature_ww = self.state.temperature_storage_target_ww_c - stsv.get_input_value(self.temperature_storage_warm_water_channel)
        delta_temperature_hw = self.state.temperature_storage_target_hw_c - stsv.get_input_value(self.temperature_storage_heating_water_channel)
        if (
