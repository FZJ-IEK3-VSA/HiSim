...
from hisim.components.generic_dhw_boiler_without_heating import Boiler
...
class L2_Controller( cp.Component ):
    ...
    def write_to_report( self ):
        ...
        lines.append("upper set temperature: {:4.0f} kW".format( ( self.T_max_heating ) ) )
        lines.append( "lower set temperature: {:4.0f} l".format( self.T_min_heating ) )
        lines.append( "tolerance: {:4.0f} l".format( self.T_tolerance))
        return lines
