...
from hisim.components.generic_ev_charger import EVChargerController, EVChargerControllerConfig
...
class SmartController(Component):
    ...
    def __init__(
        ...
        super().__init__(
            name="SmartController", my_simulation_parameters=my_simulation_parameters, my_config=config
        )
