...
class MPC_Controller(cp.Component):
    ...
    def __init__(
        ...
        temperature_Forecast_24h_1min: Optional[list] = None,
        phi_m_Forecast_24h_1min: Optional[list] = None,
        phi_ia_Forecast_24h_1min: Optional[list] = None,
        phi_st_Forecast_24h_1min: Optional[list] = None,
        pv_forecast_24h_1min: Optional[list] = None,
        PricePurchase_Forecast_24h_1min: Optional[list] = None,
        PriceInjection_Forecast_24h_1min: Optional[list] = None,
        optimal_cost: Optional[list] = None,
        revenues: Optional[list] = None,
        air_conditioning_electricity: Optional[list] = None,
        cost_optimal_temperature_set_point: Optional[list] = None,
        pv2load: Optional[list] = None,
        electricity_from_grid: Optional[list] = None,
        electricity_to_grid: Optional[list] = None,
        battery_to_load: Optional[list] = None,
        pv_to_battery_timestep: Optional[list] = None,
        battery_power_flow_timestep: Optional[list] = None,
        battery_control_state: Optional[list] = None,
        batt_soc_actual_timestep: Optional[list] = None,
        batt_soc_normalized_timestep: Optional[list] = None,
