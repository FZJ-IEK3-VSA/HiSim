...
class PIDController(cp.Component):
    ...
    def __init__(self, my_simulation_parameters: SimulationParameters,
        ...
        self.thermal_power: cp.ComponentOutput = self.add_output(self.component_name,
    ...
    def get_building_default_connections(self):
        ...
        connections.append(cp.ComponentConnection(PIDController.TemperatureMean, building_classname, Building.TemperatureMean))
        connections.append(cp.ComponentConnection(PIDController.HeatFluxWallNode, building_classname, Building.HeatFluxWallNode))
        connections.append(cp.ComponentConnection(PIDController.HeatFluxThermalMassNode, building_classname, Building.HeatFluxThermalMassNode)) 
    ...
    def i_simulate(self, timestep: int, stsv: cp.SingleTimeStepValues, force_convergence: bool) -> None:
        ...
        # if timestep <= 90*24*3600/self.my_simulation_parameters.seconds_per_timestep: 
        ...
        #     if manipulated_variable + feed_forward_signal < 0:
        #         manipulated_variable=0
        # if timestep >= 181*24*3600/self.my_simulation_parameters.seconds_per_timestep and timestep <= 243*24*3600/self.my_simulation_parameters.seconds_per_timestep:
        #     if manipulated_variable > 0:
        #         manipulated_variable = 0
