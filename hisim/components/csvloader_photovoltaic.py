...
@dataclass_json
@dataclass
class CSVLoader_photovoltaicConfig(cp.ConfigBase):
    component_name: str
    csv_filename: str
    column: int
    ...
    def get_main_classname(cls):
        ...
        return CSVLoader_photovoltaic.get_full_classname()


class CSVLoader_photovoltaic(cp.Component):
    """
    ...
    def __init__(
        self, config: CSVLoader_photovoltaicConfig, my_simulation_parameters: SimulationParameters
    ):
