...
class ElectricityMeter(DynamicComponent):
    ...
    def i_simulate(self, timestep: int, stsv: cp.SingleTimeStepValues, force_convergence: bool) -> None:
        ...
        consumption_uncontrolled_in_watt = sum([stsv.get_input_value(component_input=elem) for elem in self.consumption_uncontrolled_inputs])
        ...
        cumulative_consumption_in_watt_hour = self.state.cumulative_consumption_in_watt_hour + consumption_uncontrolled_in_watt_hour
    ...
    def get_cost_opex(
        ...
        opex_cost_per_simulated_period_in_euro = (
            self.config.total_energy_from_grid_in_kwh * euro_per_unit - self.config.total_energy_to_grid_in_kwh * revenue_euro_per_unit
        )
