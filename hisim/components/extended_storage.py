...
class WarmWaterStorage(Component):
    ...
    def __init__(self, component_name: str,my_simulation_parameters: SimulationParameters,  config: WarmWaterStorageConfig):
        ...
        self.chp_charging_side_input_temperature: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.CHP_ChargingSideInput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius, True)
        self.heating_discharging_side_input_mass: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.Heating_DischargingSideInput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec, True)
        self.heating_discharging_side_input_temperature: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.Heating_DischargingSideInput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius, True)
        # gas --> ?not mandatory?
        self.gas_charging_side_input_mass: ComponentInput = self.add_input(self.ComponentName,WarmWaterStorage.Gas_ChargingSideInput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec, True)
        self.gas_charging_side_input_temperature: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.Gas_ChargingSideInput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius, True)
        # warm water
        self.ww_discharging_side_input_mass: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.WW_DischargingSideInput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec, True)
        self.ww_discharging_side_input_temperature: ComponentInput = self.add_input(self.ComponentName, WarmWaterStorage.WW_DischargingSideInput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius, True)

        # Output
        self.chp_charging_side_output_mass: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.CHP_ChargingSideOutput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec)
        self.chp_charging_side_output_temperature: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.CHP_ChargingSideOutput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.heating_discharging_side_output_mass: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Heating_DischargingSideOutput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec)
        self.heating_discharging_side_output_temperature: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Heating_DischargingSideOutput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        # gas
        self.gas_charging_side_output_mass: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Gas_ChargingSideOutput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec)
        self.gas_charging_side_output_temperature: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Gas_ChargingSideOutput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        # warm water
        self.ww_discharging_side_output_mass: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.WW_DischargingSideOutput_mass, lt.LoadTypes.WarmWater, lt.Units.kg_per_sec)
        self.ww_discharging_side_output_temperature: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.WW_DischargingSideOutput_temperature, lt.LoadTypes.WarmWater, lt.Units.Celsius)

        # temperatures
        self.temperature_0_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature0Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.temperature_20_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature20Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.temperature_40_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature40Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.temperature_60_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature60Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.temperature_80_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature80Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.temperature_100_percent: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.Temperature100Percent, lt.LoadTypes.WarmWater, lt.Units.Celsius)

        # Outputs for information
        self.tank_enthalpy: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.TankEnthalpy, lt.LoadTypes.WarmWater, lt.Units.kWh)
        self.tank_mean_temperature: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.TankMeanTemperature, lt.LoadTypes.WarmWater, lt.Units.Celsius)
        self.amount_of_slices: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.AmountOfSlices, lt.LoadTypes.WarmWater, lt.Units.Any)
        self.heat_losses: ComponentOutput = self.add_output(self.ComponentName, WarmWaterStorage.HeatLosses, lt.LoadTypes.WarmWater, lt.Units.Watt)
