...
class GCHPConfig:
    ...
    def __init__(self, name: str, source_weight: int, p_el: float, p_th: float, p_fuel: float):
        self.name = name
    ...
    def get_default_config() -> Any:
        config = GCHPConfig(name='CHP', source_weight=1, p_el=2000, p_th=3000, p_fuel=6000)
        return config
...
class GCHP(cp.Component):
    ...
    def __init__(self, my_simulation_parameters: SimulationParameters, config: GCHPConfig) -> None:
        ...
        # Inputs
        self.L1DeviceSignalC: cp.ComponentInput = self.add_input(self.component_name, self.L1DeviceSignal, lt.LoadTypes.ON_OFF, lt.Units.BINARY,
                                                                 mandatory=True)
...
class L1CHPConfig:
    ...
    def __init__(self, name: str, source_weight: int, min_operation_time: int, min_idle_time: int, min_h2_soc: float) -> None:
        self.name = name
        self.source_weight = source_weight
    ...
    @staticmethod
    def get_default_config() -> Any:
        config = L1CHPConfig(name='L1CHPRunTimeController', source_weight=1, min_operation_time=14400, min_idle_time=7200, min_h2_soc=5)
        return config
...
class L1GenericCHPControllerState:
    ...
    def clone(self) -> Any:
        return L1GenericCHPControllerState(timestep_actual=self.timestep_actual, state=self.state,
...
class L1GenericCHPRuntimeController(cp.Component):
    ...
    def __init__(self, my_simulation_parameters: SimulationParameters, config: L1CHPConfig):
        ...
        # add inputs
        self.l2_DeviceSignalC: cp.ComponentInput = self.add_input(self.component_name, self.l2_DeviceSignal, lt.LoadTypes.ON_OFF, lt.Units.BINARY,
                                                                  mandatory=True)
        self.ElectricityTargetC: cp.ComponentInput = self.add_input(self.component_name, self.ElectricityTarget, lt.LoadTypes.ELECTRICITY,
    ...
    def get_default_connections_from_l2_generic_heat_controller(self) -> List[cp.ComponentConnection]:
        ...
        connections.append(cp.ComponentConnection(L1GenericCHPRuntimeController.l2_DeviceSignal, controller_classname,
    ...
    def get_default_connections_from_generic_hydrogen_storage(self) -> List[cp.ComponentConnection]:
        ...
        connections.append(cp.ComponentConnection(L1GenericCHPRuntimeController.HydrogenSOC, h2storage_classname,
