...
class GenericGasHeaterConfig(ConfigBase):
    ...
    def get_default_gasheater_config(
        ...
        config = GenericGasHeaterConfig(
            ...
            maximal_mass_flow_in_kilogram_per_second=maximal_power_in_watt / (4180 * 25),  # kg/s ## -> ~0.07 P_th_max / (4180 * delta_T)
...
class GasHeater(Component):
    ...
    def i_simulate(self, timestep: int, stsv: SingleTimeStepValues, force_convergence: bool) -> None:
        ...
        c_w = 4182
        mass_flow_out_temperature_in_celsius = self.temperature_delta_in_celsius + stsv.get_input_value(self.mass_flow_input_tempertaure_channel)
