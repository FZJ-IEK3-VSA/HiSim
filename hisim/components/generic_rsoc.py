...
class Rsoc(cp.Component):
    ...
    def i_simulate(self, timestep: int, stsv: SingleTimeStepValues, force_convergence: bool) -> None:
        ...
        if power_to_soec != 0.0:
            ...
            current_sys_eff_sofc = self.sofc_efficiency(name, self.current_state_sofc, self.min_power_sofc, self.max_power_sofc)
        ...
        stsv.set_output_value(self.current_output_sofc, (self.current_state_sofc * 1000))  # for WATT output in system setup
        stsv.set_output_value(self.current_load_soec, (self.current_state_soec * 1000))  # for WATT output in system setup
