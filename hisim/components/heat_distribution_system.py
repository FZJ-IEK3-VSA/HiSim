...
class HeatDistribution(cp.Component):
    ...
    def determine_water_temperature_output_after_heat_exchange_with_building_and_effective_thermal_power(
        ...
        # Tout = Tin -  Q/(c * m)
        water_temperature_output_in_celsius = water_temperature_input_in_celsius - theoretical_thermal_buiding_demand_in_watt / (
            water_mass_flow_in_kg_per_second * self.specific_heat_capacity_of_water_in_joule_per_kilogram_per_celsius
        )
        ...
        # in case no heating or cooling needed, water output is equal to water input
            ...
            raise ValueError(f"Theoretical thermal demand has unacceptable value here {theoretical_thermal_buiding_demand_in_watt}.")
...
class HeatDistributionController(cp.Component):
    ...
    def __init__(
        ...
        my_heat_distribution_controller_information = HeatDistributionControllerInformation(config=self.hsd_controller_config)
    ...
    def calc_heat_distribution_flow_and_return_temperatures(self, daily_avg_outside_temperature_in_celsius: float) -> List[float]:
        ...
        set_room_temperature_for_building_modified_in_celsius = self.set_room_temperature_for_building_in_celsius + self.building_temperature_modifier
        min_flow_temperature_modified_in_celsius = self.min_flow_temperature_in_celsius + self.building_temperature_modifier
        min_return_temperature_modified_in_celsius = self.min_return_temperature_in_celsius + self.building_temperature_modifier
        ...
        if self.set_room_temperature_for_building_in_celsius < daily_avg_outside_temperature_in_celsius:
            ...
            flow_temperature_in_celsius = float(
                ...
                + (
                    ...
                    * (
                        (set_room_temperature_for_building_modified_in_celsius - daily_avg_outside_temperature_in_celsius)
                        / (set_room_temperature_for_building_modified_in_celsius - self.heating_reference_temperature_in_celsius)
                    )
                )
...
class HeatDistributionControllerInformation:
    ...
    def prepare_calc_heating_dist_temperature(
        ...
        self.temperature_difference_between_flow_and_return_in_celsius = self.max_flow_temperature_in_celsius - self.max_return_temperature_in_celsius
    ...
    def calc_heating_distribution_system_water_mass_flow_rate(
        ...
        heating_distribution_system_water_mass_flow_in_kg_per_second = max_thermal_building_demand_in_watt / (
            specific_heat_capacity_of_water_in_joule_per_kg_per_celsius * self.temperature_difference_between_flow_and_return_in_celsius
        )
