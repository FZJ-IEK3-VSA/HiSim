...
class Occupancy(cp.Component):
    ...
    def build( self):
        ...
        if file_exists:
            ...
            pre_electricity_consumption = pd.read_csv( utils.HISIMPATH["occupancy"][self.profile_name]["electricity_consumption"],
                                                      sep = ";", decimal = ",", encoding = "cp1252")
            pre_water_consumption = pd.read_csv(utils.HISIMPATH["occupancy"][self.profile_name]["water_consumption"],
                                                sep=";", decimal=",", encoding = "cp1252")
