...
NPV-by-category and detail tables, each anyway credit multiplied out as
`share x like-for-like cost`), **Energy bill**
...
figure written out as its own division and its attribution set named).
