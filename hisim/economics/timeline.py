...
class SignViolation:
    ...
    def __str__(self) -> str:
        ...
        return (
            ...
            f"{self.expected_sign} but is ({amount.minimum}, {amount.average}, {amount.maximum})"
        )
...
def sign_violation(entry: CashFlowEntry) -> Optional[SignViolation]:
    ...
    All three slots must satisfy the expectation, not just the average: a band that straddles zero
    ...
    slots = (amount.minimum, amount.average, amount.maximum)
