...
class SingletonDictKeyEnum(enum.Enum):
    ...
    WEATHER_TEMPERATURE_OUTSIDE_YEARLY_FORECAST = 23
    ...
    WEATHER_ALTITUDE_YEARLY_FORECAST = 37
    WEATHER_DIFFUSE_HORIZONTAL_IRRADIANCE_YEARLY_FORECAST = 38
    WEATHER_DIRECT_NORMAL_IRRADIANCE_YEARLY_FORECAST = 39
    WEATHER_DIRECT_NORMAL_IRRADIANCE_EXTRA_YEARLY_FORECAST = 40
    WEATHER_GLOBAL_HORIZONTAL_IRRADIANCE_YEARLY_FORECAST = 41
    WEATHER_AZIMUTH_YEARLY_FORECAST = 42
    WEATHE_RAPPARENT_ZENITH_YEARLY_FORECAST = 43
    HEATINGBYRESIDENTSYEARLYFORECAST = 44
    WEATHER_WINDSPEED_YEARLY_FORECAST = 45
    WEATHER_PRESSURE_YEARLY_FORECAST = 46
