...
class SingletonDictKeyEnum(enum.Enum):
    ...
    pv_included = 20
    pv_peak_power = 21
    smart_devices_included = 22
    battery_included = 23
    mpc_battery_capacity = 24
    cop_coef_heating = 25
    eer_coef_cooling = 26
    Weather_TemperatureOutside_yearly_forecast = 27
    Heat_flux_thermal_mass_node_forecast = 28
    Heat_flux_surface_node_forecast = 29
    Heat_flux_indoor_air_node_forecast = 30
    pv_forecast_yearly = 31
    ...
    Price_Purchase_Forecast_24h = 38
    Price_Injection_Forecast_24h = 39
    Weather_Altitude_yearly_forecast = 40
    Weather_DiffuseHorizontalIrradiance_yearly_forecast = 41
    Weather_DirectNormalIrradiance_yearly_forecast = 42
    Weather_DirectNormalIrradianceExtra_yearly_forecast = 43
    Weather_GlobalHorizontalIrradiance_yearly_forecast = 44
