...
from repositories.HiSim.obsolete.ems_strategies_masterthesis.household_5a_with_car_priority_advanced_hp_ev_pv_battery import HouseholdAdvancedHpEvPvBatteryConfig
...
def setup_function(
    ...
    for car_information in my_car_information.data_dict_for_car_component.values():
        # Build Electric Vehicles
        my_car_config.name = car_information.car_name + f"_{car_number}"
    ...
    if clever:
        ...
        my_electricity_controller.add_component_input_and_connect(
            source_object_name=my_domestic_hot_water_heatpump.component_name,
            source_component_output=my_domestic_hot_water_heatpump.ElectricityOutput,
            source_load_type=lt.LoadTypes.ELECTRICITY,
            source_unit=lt.Units.WATT,
            source_tags=[
        ...
        my_electricity_controller.add_component_output(
            ...
            # source_weight=my_domestic_hot_water_heatpump.config.source_weight,
            source_weight=3,
            source_load_type=lt.LoadTypes.ELECTRICITY,
            source_unit=lt.Units.WATT,
