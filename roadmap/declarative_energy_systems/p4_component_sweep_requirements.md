...
- Unconverted classes in the recorded setups (P3 inventory §3b): 32 classes at the survey; by instantiation count PV 17, battery 13 and the fuel/gas meters 4 each (**all converted 2026-09-13**, B2), DHW storage 13, buffer storage 12, hplib heat pump + 2 controllers 4 each.
