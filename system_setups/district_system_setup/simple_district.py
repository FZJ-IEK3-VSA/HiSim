...
def setup_function(
    ...
    if my_simulation_parameters is None:
        ...
        my_simulation_parameters.post_processing_options.append(PostProcessingOptions.WRITE_CAPEX_TO_REPORT)
    ...
    for i, name in enumerate(district_list_bui_names):
        ...
        district_list.append(simple_generic_household.GenericBuilding(
            my_sim=my_sim,
