"""Golden reference system setup: gas heating with radiator distribution.

Hard-wired variant of household_gas_building_sizer with fixed heating system and
...
def setup_function(
    ...
    energy_system_config_.heating_system = HeatingSystems.GAS_HEATING
    energy_system_config_.heat_distribution_system = ComponentType.HEAT_DISTRIBUTION_SYSTEM_RADIATOR
