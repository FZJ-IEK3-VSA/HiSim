"""Golden reference system setup: heat pump with electric car and floor heating distribution.

Hard-wired variant of household_heatpump_car_building_sizer with fixed heating system and
heat distribution system. Includes PV, battery and EMS (sizer defaults).
"""
...
def setup_function(
    ...
    - Components
        ...
        - Electricity Meter
        - Electric Car
        - Electric Car Charging Controller
    ...
    energy_system_config_.heating_system = HeatingSystems.HEAT_PUMP
    ...
    for car in my_cars:
        ...
        car_number += 1
    # Make car component connections
        ...
        for car, car_battery, car_battery_controller in zip(my_cars, my_car_batteries, my_car_battery_controllers):
            if car_surplus_charging:
                ...
                electricity_target = my_electricity_controller.add_component_output(
                    source_output_name=f"ElectricityToOrFromGridOf{car_battery_controller.get_classname()}_",
                    source_tags=[
                        lt.ComponentType.CAR_BATTERY,
                        lt.InandOutputType.ELECTRICITY_TARGET,
                    ],
                    source_component_class=car_battery_controller.get_classname(),
                    source_weight=5,
                    source_load_type=lt.LoadTypes.ELECTRICITY,
                    source_unit=lt.Units.WATT,
