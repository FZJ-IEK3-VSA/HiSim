"""Golden reference system setup: heat pump with solar thermal and floor heating distribution.

Hard-wired variant of household_heatpump_solar_thermal_building_sizer with fixed heating system
and heat distribution system. Includes PV, battery and EMS (sizer defaults).
"""
...
def setup_function(
    ...
    This setup function emulates a household whose electricity, warm water and heating needs are
    covered by an air-source heat pump supported by a solar thermal system (solar thermal as primary
    DHW source, heat pump as secondary). It includes the following components:
    ...
    - Components
        ...
        - Photovoltaic System
        - Building
        - Heat Pump (air source, space heating and DHW)
        - Heat Pump Controller (Space Heating)
        - Heat Pump Controller (DHW)
        - Solar Thermal System
        - Solar Thermal System Controller
        - Heat Distribution System
        - Heat Distribution Controller
        - Buffer Hot Water Storage
        - DHW Storage
        - Battery
    ...
    # === Golden reference: hard-wire heating system and heat distribution system (ignore any passed config) ===
    energy_system_config_.heating_system = HeatingSystems.HEAT_PUMP_SOLAR_THERMAL
    energy_system_config_.heat_distribution_system = ComponentType.HEAT_DISTRIBUTION_SYSTEM_FLOORHEATING
    ...
    # Connect heat pump as secondary heat generator
    my_dhw_storage.connect_input(
