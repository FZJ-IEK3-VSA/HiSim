"""Golden reference system setup: hydrogen heating with floor heating distribution.

Hard-wired variant of household_hydrogen_boiler_building_sizer with fixed heating system and
...
def setup_function(
    ...
    energy_system_config_.heating_system = HeatingSystems.HYDROGEN_HEATING
