"""Golden reference system setup: oil heating with radiator distribution.
...
def setup_function(
    ...
    energy_system_config_.heating_system = HeatingSystems.OIL_HEATING
