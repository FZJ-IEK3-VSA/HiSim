"""Golden reference system setup: pellet heating with floor heating distribution.

Hard-wired variant of household_pellets_building_sizer with fixed heating system and
heat distribution system. PV, battery and EMS follow the sizer defaults.
"""
...
def setup_function(
    ...
    energy_system_config_.heating_system = HeatingSystems.PELLET_HEATING
    ...
    my_pellet_heater_controller = generic_boiler.GenericBoilerController(
        my_simulation_parameters=my_simulation_parameters,
        config=my_pellet_heater_controller_config,
    )
