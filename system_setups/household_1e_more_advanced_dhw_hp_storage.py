...
from hisim.components import simple_dhw_storage
...
class HouseholdMoreAdvancedHPDieselCarDHWStorageConfig(SystemSetupConfigBase):
    ...
    dhw_storage_config: simple_dhw_storage.SimpleDHWStorageConfig
...
def setup_function(
    ...
    #################################
    my_heatpump.connect_only_predefined_connections(my_heatpump_controller_space_heating,
                                                    my_heatpump_controller_dhw, my_weather, my_hot_water_storage,)
    ...
    my_heatpump_controller_space_heating.connect_only_predefined_connections(my_heat_distribution_controller,
                                                                        my_weather,
