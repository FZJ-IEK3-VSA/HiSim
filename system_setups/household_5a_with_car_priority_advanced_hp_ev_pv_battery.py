...
class HouseholdAdvancedHpEvPvBatteryConfig(SystemSetupConfigBase):
    ...
    def get_default(cls):
        ...
        household_config = HouseholdAdvancedHpEvPvBatteryConfig(
            ...
            advanced_battery_config=advanced_battery_bslib.BatteryConfig.get_scaled_battery(total_pv_power_in_watt_peak=pv_config.power_in_watt),
...
def setup_function(my_sim: Any, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:  # noqa: too-many-statements
    ...
    my_simulation_parameters.surplus_control = my_config.surplus_control_car  # EV charger is controlled by simulation_parameters
