...
def setup_function(
    ...
    if config_filename is not None:
        ...
        SingletonSimRepository().set_entry(
            ...
            entry=f"surplus_control_{surplus_control}_building_modifier_{surplus_control_building_temperature_modifier}_{hash_number}_battery_prio",
        )
    ...
    ResultPathProviderSingleton().set_important_result_path_information(
        ...
        variant_name=f"surplus_control_{surplus_control}_building_modifier_{surplus_control_building_temperature_modifier}_battery_prio",
