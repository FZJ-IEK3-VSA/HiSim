...
def setup_function(
    ...
    my_district_heating_controller_sh_config = generic_district_heating.DistrictHeatingControllerConfig.get_default_district_heating_controller_config(with_domestic_hot_water_preparation=True)
