...
def setup_function(
    ...
    # DHW gas heater and storage configs
    ...
    if my_simulation_parameters.result_directory == "":
        ...
        ResultPathProviderSingleton().set_important_result_path_information(
            module_directory="/storage_cluster/projects/2024-k-rieck-hisim-mass-simulations/analysis_austria_for_kristina_18_11_2024",  # my_sim.module_directory,
