"""  Reference Household system setup with gas heater. """
...
@dataclass_json
@dataclass
class WebtoolGas(SystemSetupConfigBase):

    """Configuration for WebtoolGas."""
    ...
    # TODO: Do scaling.
    @classmethod
    def get_scaled_default(cls, building_config: building.BuildingConfig) -> "WebtoolGas":
        """Get default WebtoolGas."""
...
def setup_function(my_sim: Any, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:  # noqa: too-many-statements
    ...
    if my_sim.my_module_config_path:
        my_config = WebtoolGas.load_from_json(my_sim.my_module_config_path)
    else:
        my_config = WebtoolGas.get_default()
    # =================================================================================
