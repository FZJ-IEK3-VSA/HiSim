...
@dataclass_json
@dataclass
class WebtoolGasDieselCar(SystemSetupConfigBase):

    """Configuration for WebtoolGasDieselCar."""
    ...
    @classmethod
    def get_default(cls) -> "WebtoolGasDieselCar":
        """Get default WebtoolGasDieselCar."""
    ...
    # TODO: Do scaling.
    @classmethod
    def get_scaled_default(cls, building_config: building.BuildingConfig) -> "WebtoolGasDieselCar":
        """Get default WebtoolGasDieselCar."""
        ...
        household_config = WebtoolGasDieselCar(
            building_type="blub",
...
def setup_function(my_sim: Any, my_simulation_parameters: Optional[SimulationParameters] = None) -> None:  # noqa: too-many-statements
    ...
    # my_config = utils.create_configuration(my_sim, WebtoolGasDieselCar)
    ...
    if my_sim.my_module_config_path:
        my_config = WebtoolGasDieselCar.load_from_json(my_sim.my_module_config_path)
    else:
        my_config = WebtoolGasDieselCar.get_default()
    # =================================================================================
