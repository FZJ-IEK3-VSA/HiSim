...
def get_number_of_outputs(list_of_components:list):
    number_of_outputs=0
...
def add_global_index_of_real_components(list_of_components:list,number_of_fake_inputs:int):
...
def add_global_index_of_components(list_of_components:list):
