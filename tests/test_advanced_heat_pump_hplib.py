...
def test_heat_pump_hplib():
    ...
    heatpump_config=HeatPumpHplibConfig(model=model, group_id=group_id, t_in=t_in, t_out_val=t_out, p_th_set=p_th_set, cycling_mode=True, minimum_idle_time_in_seconds=600, minimum_running_time_in_seconds=600)
