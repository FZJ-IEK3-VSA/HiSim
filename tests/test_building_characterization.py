...
``BuildingConfig.presets.german_single_family_home``, and per the phase spec a harness
that has to be edited mid-refactor proves nothing -- which is exactly what happened: the
3006 golden assertions did not move.
