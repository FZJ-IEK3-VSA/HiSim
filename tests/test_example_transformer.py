...
def test_example_transformer():
    ...
    my_example_transformer_config = (
        example_transformer.TransformerConfig.get_default_transformer()
    )
    print("\n")
    log.information(
        "default transformer config " + str(my_example_transformer_config) + "\n"
    )
    my_example_transformer = example_transformer.Transformer(
    ...
    my_example_transformer.input1.source_output = (
        transformerinput1_output
    )
    my_example_transformer.input2.source_output = (
        transformerinput2_output
    )
    ...
    log.information(
        "output1 = "
        + str(stsv.values[my_example_transformer.output1.global_index])
    )
    log.information(
        "output2 = "
        + str(stsv.values[my_example_transformer.output2.global_index])
    )
