...
def test_simple_bucket_boiler_state():
    ...
    my_boiler.l1_DeviceSignalC.source_output = my_boiler_controller_l1.l1_DeviceSignalC
    ...
    my_boiler_controller_l1.l1_DeviceSignalC.global_index = 2
    my_boiler_controller_l2.l2_DeviceSignalC.global_index = 3
    my_boiler.ElectricityOutputC.global_index = 4
