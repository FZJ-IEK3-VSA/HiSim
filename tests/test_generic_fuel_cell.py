...
def test_electrolyzer():
    ...
    demand_profile_target = cp.ComponentOutput(
        "FakeDemandProfile", "DemandProfile", lt.LoadTypes.ELECTRICITY, lt.Units.KILOWATT
    )
    ...
    assert (
            stsv.values[my_fuelcell.current_hydrogen_demand.global_index] == 0.3784711401282074
        )
