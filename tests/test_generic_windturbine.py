...
def test_windturbine():
    ...
    my_windturbine = generic_windturbine.Windturbine(config=my_windturbine_config, my_simulation_parameters=mysim)
    ...
    log.information(
        "windturbine electricity output [W]: "
        + str(stsv.values[my_windturbine.electricity_output_channel.global_index])
    )
