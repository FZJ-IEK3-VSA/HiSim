...
def test_house(
    ...
    heat_consumption_in_kilowatt_hour = jsondata["Heating Meter"]["Total heat consumption"].get("value")
    ...
    opex_costs_for_heat_in_euro = jsondata["Heating Meter"]["Opex costs of heat consumption"].get("value")

    co2_footprint_due_to_heat_use_in_kg = jsondata["Heating Meter"][
        "CO2 footprint of heat consumption"
    ].get("value")
