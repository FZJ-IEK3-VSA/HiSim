...
@pytest.mark.utsp
def test_occupancy_scaling_with_utsp() -> None:
...
def initialize_lpg_utsp_connector_and_return_results(
    ...
    """Initialize the LPG UTSP connector and simulate one timestep, returning key results.

    Args:
        households: A single household reference or a list of household references
            to scale the occupancy profile.

    Returns:
        A tuple of:
            number_of_residents: Total number of residents across all households.
            heating_by_residents: Heating energy generated by residents.
            heating_by_devices: Heating energy generated by devices.
