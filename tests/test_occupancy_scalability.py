...
def test_building_scalability():
    ...
    log.information(
        "Building Config Number of Apartments "
        + str(my_residence_config.number_of_apartments)
    )
    log.information(
        "Building Config Absolute Conditioned Floor Area: "
        + str(my_residence_config.absolute_conditioned_floor_area_in_m2)
    )

    building_conditioned_floor_area_in_m2 = (
        my_residence.scaled_conditioned_floor_area_in_m2
    )
    ...
    log.information(
        "Building Conditioned Floor Area " + str(building_conditioned_floor_area_in_m2)
    )
    log.information(
    ...
    for factor in scaling_factors:
        ...
        scaling_factor_number_of_apartments = (
            number_of_apartments_building_upscaled
            / my_occupancy_config.number_of_apartments
        )
        log.information(
        ...
        log.information(
            "Occupancy outputs upscaled " + str(occupancy_outputs_upscaled) + "\n"
        )
